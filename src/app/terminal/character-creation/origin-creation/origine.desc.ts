import { improvedPerception, necroticPostHuman, propulsion, protectron, radiationSponge, TraitDescription } from '../trait-creation/trait.desc';
export const STATS = [
    'Force',
    'Perception',
    'Endurance',
...
export const SuperMutant: OrigineDescription = {
    ...
    "handicap": "Les seules armures que vous pouvez porter doivent être spécialement conçues pour les super mutants."
};
